...
#### 2.2.0: Folding (**BACKLOG**) - **AREA:** ‹no-area› - <nobr>***DREAMED** REQT-qerexp825r*</nobr>
 ...
 - **2.2.4: Fold reset** (**BACKLOG**) - **viewer keeps the state; an optional fold control resets it** The viewer MUST keep the expanded-fold state itself, and MUST let a consumer holding its fold control return every expanded fold to folded. The fold control MUST be optional, so that a consumer which never resets does not hold one. <nobr>***draft** REQT-869jyzdes7*</nobr>
